...
BOOST_AUTO_TEST_CASE(add_client_basic)
{
  ...
  BOOST_CHECK(out.find("<client added>") != std::string::npos || out.find("Bank not found") != std::string::npos);
}
...
BOOST_AUTO_TEST_CASE(remove_client_basic)
{
  ...
  BOOST_CHECK(out.find("<removed>") != std::string::npos || out.find("Bank not found") != std::string::npos);
}
...
BOOST_AUTO_TEST_CASE(list_does_not_crash)
{
  ...
  BOOST_CHECK(out.find("Alpha") != std::string::npos || out.find("Bank not found") != std::string::npos);
}
...
BOOST_AUTO_TEST_CASE(show_command_safe)
{
  ...
  BOOST_CHECK(out.find("loan=") != std::string::npos || out.find("Client not found") != std::string::npos || out.find("Bank not found") != std::string::npos);
}
...
BOOST_AUTO_TEST_CASE(solve_outputs_something)
{
  ...
  BOOST_CHECK(out.find("solve") != std::string::npos || out.find("Bank not found") != std::string::npos);
}
