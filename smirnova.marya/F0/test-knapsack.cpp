...
BOOST_AUTO_TEST_CASE(bank_not_found)
{
  ...
  BOOST_CHECK(out.find("Bank not found") != std::string::npos || out.find("solve") == std::string::npos);
}
...
BOOST_AUTO_TEST_CASE(single_client)
{
  ...
  BOOST_CHECK(out.find("approved:") != std::string::npos || out.find("rejected:") != std::string::npos || out.find("solve") != std::string::npos);
}
...
BOOST_AUTO_TEST_CASE(limit_forces_rejection)
{
  ...
  BOOST_CHECK(out.find("solve") != std::string::npos || out.find("approved:") != std::string::npos || out.find("rejected:") != std::string::npos);
}
